...
<body>
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              <div class="hidden sm:ml-6 sm:block">
                <div class="flex space-x-4">
                  <a href="#" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Agregar usuario</a>
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Agregar un Nuevo usuario</h2>
        </div>
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" method="POST" enctype="multipart/form-data">
                <div>
                    <label for="titulo" class="block text-sm font-medium leading-6 text-gray-900">Ingrese su nombre usuario</label>
                    <div class="mt-2">
                ...
                <div>
                    <label for="idLibro" class="block text-sm font-medium leading-6 text-gray-900">Ingrese apellido</label>
                    <div class="mt-2">
                ...
                <div>
                    <label for="idLibro" class="block text-sm font-medium leading-6 text-gray-900">Ingrese correo</label>
                    <div class="mt-2">
                        <input id="idLibro" name="idLibro" type="number" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div>
                    <labels class="block text-sm font-medium leading-6 text-gray-900">Ingrese contraseña</labels>
                    <div class="mt-2">
                        <input id="idLibro" name="idLibro" tSype="number" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
